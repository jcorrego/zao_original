...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5b55f70651faa1_00517787',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b55f70651faa1_00517787')) {function content_5b55f70651faa1_00517787($_smarty_tpl) {?><div id="search_block_top" class="col-lg-6"><div class="icono-buscador-top" data-accion="abrir"></div><form id="searchbox" method="get" action="//www.zaomakeup.com.co/buscar" class="form-buscador-top"><div class="input-group"> <input type="hidden" name="controller" value="search" /> <input type="hidden" name="orderby" value="position" /> <input type="hidden" name="orderway" value="desc" /> <input class="search_query form-control" type="text" id="search_query_top" name="search_query" placeholder="Buscar" value="" /> <span class="input-group-btn"> <button type="submit" name="submit_search" class="btn btn-outline-inverse"> <span class="button-search fa fa-search"><span class="unvisible">Buscar</span></span> </button></span></div></form></div><?php }} ?>
