<?php /* Smarty version Smarty-3.1.19, created on 2018-07-18 16:33:36
         compiled from "/home/wwwzaon/public_html/themes/ap_office/authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8195397695b4fb230be6125-03734475%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9f1f8809bc7c17f75cf0b576f01d765a1ab38131' => 
    array (
      0 => '/home/wwwzaon/public_html/themes/ap_office/authentication.tpl',
      1 => 1490551626,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8195397695b4fb230be6125-03734475',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b4fb232099433_98958206',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b4fb232099433_98958206')) {function content_5b4fb232099433_98958206($_smarty_tpl) {?>
...
" method="post" id="login_form" class="box">
				<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Already registered?'),$_smarty_tpl);?>
</span></h3>
...
" method="post" id="create-account_form" class="box">
				<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Create an account'),$_smarty_tpl);?>
</span></h3>
				<div class="form_content clearfix">
...
" method="post" id="new_account_form" class="std clearfix form-horizontal">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h3 class="page-subheading bottom-indent"><span><?php echo smartyTranslate(array('s'=>'Instant checkout'),$_smarty_tpl);?>
</span></h3>
...
&nbsp;&nbsp;</option>
					...
					<?php }?>
					<h3 class="page-subheading bottom-indent top-indent"><span><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
</span></h3>
...
" />
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						<?php $_smarty_tpl->tpl_vars['postCodeExist'] = new Smarty_variable(false, null, 0);?>
						<?php $_smarty_tpl->tpl_vars['dniExist'] = new Smarty_variable(false, null, 0);?>
						<h3 class="page-subheading top-indent"><span><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
</span></h3>
						<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
...
" method="post" id="account-creation_form" class="std box form-horizontal">
		...
		<div class="account_creation">
			<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Your personal information'),$_smarty_tpl);?>
</span></h3>
			<p class="required"><sup>*</sup><?php echo smartyTranslate(array('s'=>'Required field'),$_smarty_tpl);?>
</p>
...
&nbsp;&nbsp;</option>
		...
		<?php if ($_smarty_tpl->tpl_vars['b2b_enable']->value) {?>
			<div class="account_creation">
				<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Your company information'),$_smarty_tpl);?>
</span></h3>
				<div class="form-group">
...
<?php }?>" />
		...
		<?php if (isset($_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value)&&$_smarty_tpl->tpl_vars['PS_REGISTRATION_PROCESS_TYPE']->value) {?>
			<div class="account_creation">
				<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Your address'),$_smarty_tpl);?>
</span></h3>
				<?php  $_smarty_tpl->tpl_vars['field_name'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['field_name']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['dlv_all_fields']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['field_name']->key => $_smarty_tpl->tpl_vars['field_name']->value) {
...
<?php }?>" />
			...
			<div class="account_creation dni">
				<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Tax identification'),$_smarty_tpl);?>
</span></h3>
				<div class="required form-group">
					<label class="control-label col-sm-4" for="dni"><?php echo smartyTranslate(array('s'=>'Identification number'),$_smarty_tpl);?>
 <sup>*</sup></label>
