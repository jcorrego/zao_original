<?php /* Smarty version Smarty-3.1.19, created on 2018-07-23 10:42:37
         compiled from "/home/wwwzaon/public_html/themes/ap_office/order-address.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14492397735b55f76d3a90c4-37315828%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a0558bc3d8bd9773e78e035dfe49fe37ee1914ef' => 
    array (
      0 => '/home/wwwzaon/public_html/themes/ap_office/order-address.tpl',
      1 => 1501697544,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14492397735b55f76d3a90c4-37315828',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b55f76e6824e3_37860802',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b55f76e6824e3_37860802')) {function content_5b55f76e6824e3_37860802($_smarty_tpl) {?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', null, null); ob_start(); ?><h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Your billing address','js'=>1),$_smarty_tpl);?>
</span></h3><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
...
<?php $_smarty_tpl->_capture_stack[0][] = array('default', null, null); ob_start(); ?><h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Your delivery address','js'=>1),$_smarty_tpl);?>
</span></h3><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
