<?php /* Smarty version Smarty-3.1.19, created on 2018-08-04 06:41:04
         compiled from "/home/wwwzaon/public_html/themes/ap_office/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1911159585b6590d0acfa35-31716887%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'da7fc4f4d4a3955e2b5d1bbe807269c71294013d' => 
    array (
      0 => '/home/wwwzaon/public_html/themes/ap_office/order-detail.tpl',
      1 => 1491087244,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1911159585b6590d0acfa35-31716887',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5b6590d19fdbf6_95646537',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b6590d19fdbf6_95646537')) {function content_5b6590d19fdbf6_95646537($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/wwwzaon/public_html/tools/smarty/plugins/modifier.replace.php';
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6"<?php if ($_smarty_tpl->tpl_vars['order']->value->isVirtual()) {?> style="display:none;"<?php }?>>
			<ul class="address alternate_item box">
				<li><h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Delivery address'),$_smarty_tpl);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['deliveryAddressFormatedValues']->value[smarty_modifier_replace($_smarty_tpl->tpl_vars['word_item']->value,',','')], ENT_QUOTES, 'UTF-8', true);?>
		...
		<div class="col-xs-12 col-sm-6">
			<ul class="address item <?php if ($_smarty_tpl->tpl_vars['order']->value->isVirtual()) {?>full_width<?php }?> box">
				<li><h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Invoice address'),$_smarty_tpl);?>
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th class="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>item<?php } else { ?>first_item<?php }?>"><?php echo smartyTranslate(array('s'=>'Referencia'),$_smarty_tpl);?>
</th>
				<th class="item"><?php echo smartyTranslate(array('s'=>'Producto'),$_smarty_tpl);?>
</th>
				<th class="item"><?php echo smartyTranslate(array('s'=>'Cantidad'),$_smarty_tpl);?>
</th>
				...
				<?php }?>
				<th class="item"><?php echo smartyTranslate(array('s'=>'Precio Unit.'),$_smarty_tpl);?>
</th>
				<th class="last_item"><?php echo smartyTranslate(array('s'=>'Precio Total'),$_smarty_tpl);?>
</th>
			</tr>
		</thead>
		<tfoot>
...
<?php }?> </strong>
			...
			<tr class="item">
				<td colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>2<?php } else { ?>1<?php }?>">
					<strong><?php echo smartyTranslate(array('s'=>'Total descuentos'),$_smarty_tpl);?>
</strong>
				</td>
				<td colspan="<?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()) {?>5<?php } else { ?>4<?php }?>">
			...
			<tr class="item">
				<td colspan="<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>2<?php } else { ?>1<?php }?>">
					<strong><?php echo smartyTranslate(array('s'=>'Envio y manejo'),$_smarty_tpl);?>
 <?php if ($_smarty_tpl->tpl_vars['use_tax']->value) {?><?php echo smartyTranslate(array('s'=>'(tax incl.)'),$_smarty_tpl);?>
<?php }?> </strong>
				</td>
				<td colspan="<?php if ($_smarty_tpl->tpl_vars['order']->value->hasProductReturned()) {?>5<?php } else { ?>4<?php }?>">
...
<?php if ($_smarty_tpl->tpl_vars['return_allowed']->value) {?>
	<div id="returnOrderMessage">
		<h3 class="page-subheading bottom-indent"><span><?php echo smartyTranslate(array('s'=>'Merchandise return'),$_smarty_tpl);?>
</span></h3>
...
<?php if (!$_smarty_tpl->tpl_vars['is_guest']->value) {?>
	...
	<h3 class="page-subheading"><span><?php echo smartyTranslate(array('s'=>'Messages'),$_smarty_tpl);?>
</span></h3>
...
" method="post" class="std" id="sendOrderMessage">
		<h3 class="page-subheading bottom-indent"><span><?php echo smartyTranslate(array('s'=>'Add a message'),$_smarty_tpl);?>
</span></h3>
		...
		<p class="form-group">
		<label for="id_product"><?php echo smartyTranslate(array('s'=>'Producto'),$_smarty_tpl);?>
</label>
