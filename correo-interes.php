...
/home/wwwzaon/public_html/formulario-interes.php
...
<?php
	...
	//if(isset($_POST['Form'])){
		if(!empty($_POST['nombre']) && !empty($_POST['email']) && !empty($_POST['tel_cel']) && !empty($_POST['empresa']) && !empty($_POST['mensaje'])){
				...
				<div style="background-color:#DDDDDD; padding:20px;">
					<center>
						<div style="width:600px; background-color:#FFFFFF; border-radius:5px;font-size:14px; font-family:Arial, Helvetica, sans-serif;">
							...
							<table width="600" border="0" cellspacing="0" cellpadding="20" style="background-color:#FDFDFD;">
								<tr>
									<td colspan="2" style="background:url(\'http://www.paginaswebcali.comimages/clouds.png\');color:#FFFFFF;">
										<br><br><br>
										<a href="http://www.paginaswebcali.com" style="text-decoration:none;">	
											...
											<img src="http://www.paginaswebcali.com/images/equipo.png" />
										</a>
									</td>
								</tr>
							</table>
