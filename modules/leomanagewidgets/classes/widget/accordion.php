			...
			$this->fields_form[1]['form'] = array(
	            ...
	            'input' => array(
					...
					array(
				        ...
				        'lang'  => true,
				        'autoload_rte' => true,
				        'desc'	=> $this->l('Enter Content 7')
				    ),

                    array(
				        'type'  => 'text',
				        'label' => $this->l('Header 8'),
				        'name'  => 'header_8',
				        'default'=> '',
				        'lang'=> true
				    ),
					array(
				        ...
				        'lang'  => true,
				        'autoload_rte' => true,
				        'desc'	=> $this->l('Enter Content 8') 
				    ), 
                    
                    array(
				        'type'  => 'text',
				        'label' => $this->l('Header 9'),
				        'name'  => 'header_9',
				        'default'=> '',
				        'lang'=> true
				    ),
					array(
				        ...
				        'lang'  => true,
				        'autoload_rte' => true,
				        'desc'	=> $this->l('Enter Content 9') 
				    ), 
                    
                    array(
				        'type'  => 'text',
				        'label' => $this->l('Header 10'),
				        'name'  => 'header_10',
				        'default'=> '',
				        'lang'=> true
				    ),
					array(
				        ...
				        'lang'  => true,
				        'autoload_rte' => true,
				        'desc'	=> $this->l('Enter Content 10') 
				    ), 
                    
                    array(
				        'type'  => 'text',
				        'label' => $this->l('Header 11'),
				        'name'  => 'header_11',
				        'default'=> '',
				        'lang'=> true
				    ),
					array(
				        ...
				        'lang'  => true,
				        'autoload_rte' => true,
				        'desc'	=> $this->l('Enter Content 11') 
				    ), 
                    
                    array(
				        'type'  => 'text',
				        'label' => $this->l('Header 12'),
				        'name'  => 'header_12',
				        'default'=> '',
				        'lang'=> true
				    ),
