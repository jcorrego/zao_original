    ...
    public function __construct()
    {
        ...
        if ($this->_leotype == 1) {
            ...
            $this->_hooksPos = array(
                ...
                'displayProductosDestacados',
                'displayMejorVendidos',
                'displayProductosNuevos',
                'displayProductosRecomendados',
                'displayDatosContactoCabecera',
                'displayCertificaciones',
                'displayPreguntasFrecuentes',
                'displayPreguntasFrecuentesCertificacionOrganica',
                'displayTextoCabecera',
...
//        }
    ...
    public function hookDisplayProductosDestacados()
    {
        return $this->_processHook("displayProductosDestacados");
    }
    public function hookDisplayMejorVendidos()
    {
        return $this->_processHook("displayMejorVendidos");
    }
    public function hookDisplayProductosNuevos()
    {
        return $this->_processHook("displayProductosNuevos");
    }
    public function hookDisplayProductosRecomendados()
    {
        return $this->_processHook("displayProductosRecomendados");
    }
    public function hookDisplayDatosContactoCabecera()
    {
        return $this->_processHook("displayDatosContactoCabecera");
    }
    public function hookDisplayCertificaciones()
    {
        return $this->_processHook("displayCertificaciones");
    }
    public function hookDisplayPreguntasFrecuentes()
    {
        return $this->_processHook("displayPreguntasFrecuentes");
    }
    public function hookDisplayPreguntasFrecuentesCertificacionOrganica()
    {
        return $this->_processHook("displayPreguntasFrecuentesCertificacionOrganica");
    }
    public function hookDisplayTextoCabecera()
    {
        return $this->_processHook("displayTextoCabecera");
    }
}