		...
		{if $comments}
				...
				<div class="comment row" itemprop="review" itemscope itemtype="https://schema.org/Review">
					<div class="comment_author col-sm-2">
						<div itemprop="itemReviewed" itemscope itemtype="https://schema.org/Restaurant">
							<span itemprop="name">{l s='Valoración' mod='productcomments'}&nbsp;</span>
						</div>
			...
			<p class="align_center">
				<a id="new_comment_tab_btn" class="btn btn-outline button button-small btn-sm open-comment-form" href="#new_comment_form">
					<span>{l s='¡Escribe tu valoración!' mod='productcomments'}</span> 
				</a>
			</p>
			{/if}
		{else}
			...
			<p class="align_center">
				<a id="new_comment_tab_btn" class="btn btn-outline button button-small btn-sm open-comment-form" href="#new_comment_form">
					<span>{l s='¡Sé el primero en valorar!' mod='productcomments'}</span>
				</a>
			</p>
			{else}
			<p class="align_center no-val">{l s='No hay ninguna valoración por el momento' mod='productcomments'}</p>
			{/if}
		{/if}	
