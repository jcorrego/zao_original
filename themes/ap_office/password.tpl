                ...
                <form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std" id="form_forgotpassword">
                    <fieldset>
                        ...
                        <p class="submit">
                            ...
                            <a class="btn btn-outline button button-small btn-sm" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><span>{l s='Back to Login'}</span></a>
                        </p>
                    </fieldset>
                </form>
                {/if}
